...
namespace webProjeV2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Kullanici { UserName = Input.Email, Email = Input.Email, KullaniciAdVeSoyad=Input.KullaniciAdVeSoyad, KullaniciCinsiyet=Input.KullaniciCinsiyet, DogumTarihi=Input.DogumTarihi};
